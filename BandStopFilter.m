function varargout = BandStopFilter(varargin)
...
% Last Modified by GUIDE v2.5 28-Aug-2016 09:35:54

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @BandStopFilter_OpeningFcn, ...
                   'gui_OutputFcn',  @BandStopFilter_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before BandStopFilter is made visible.
function BandStopFilter_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to BandStopFilter (see VARARGIN)

% Choose default command line output for BandStopFilter
...
% UIWAIT makes BandStopFilter wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = BandStopFilter_OutputFcn(hObject, eventdata, handles) 
...
cfg = [];
cfg.bpfilter = 'yes';
cfg.bpfreq = eval(get(handles.editBandStop,'String'));
