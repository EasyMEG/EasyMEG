...
function editMEG_Callback(hObject, eventdata, handles)
% hObject    handle to editMEG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of editMEG as text
%        str2double(get(hObject,'String')) returns contents of editMEG as a double


% --- Executes during object creation, after setting all properties.
function editMEG_CreateFcn(hObject, eventdata, handles)
% hObject    handle to editMEG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
function editEMG_Callback(hObject, eventdata, handles)
% hObject    handle to editEMG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of editEMG as text
%        str2double(get(hObject,'String')) returns contents of editEMG as a double


% --- Executes during object creation, after setting all properties.
function editEMG_CreateFcn(hObject, eventdata, handles)
% hObject    handle to editEMG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function editECG_Callback(hObject, eventdata, handles)
% hObject    handle to editECG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of editECG as text
%        str2double(get(hObject,'String')) returns contents of editECG as a double


% --- Executes during object creation, after setting all properties.
function editECG_CreateFcn(hObject, eventdata, handles)
% hObject    handle to editECG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function editEOG_Callback(hObject, eventdata, handles)
% hObject    handle to editEOG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of editEOG as text
%        str2double(get(hObject,'String')) returns contents of editEOG as a double


% --- Executes during object creation, after setting all properties.
function editEOG_CreateFcn(hObject, eventdata, handles)
% hObject    handle to editEOG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
